...
void sendsignal(char* sigvalue)
{
   ...
   ret = dbus_bus_request_name(conn, "test.method.client2", DBUS_NAME_FLAG_REPLACE_EXISTING , &err);
   if (dbus_error_is_set(&err)) {
   ...
   msg = dbus_message_new_signal("/test/method/Object", // object name of the signal
